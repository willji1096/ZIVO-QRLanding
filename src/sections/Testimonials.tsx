...
const REVIEWS = [
  ...
  { name: '박서연 사장님', loc: '홍대 카페', text: '외국인 비율이 40%인데, 영어 메뉴판 만들 필요 없이 QR 하나로 해결. 17개 언어라니.', metric: '메뉴 번역 비용 0원' },
  { name: '이준혁 점장', loc: '이태원 BBQ', text: '오주문이 거의 사라졌어요. 예전엔 매일 1-2건씩 잘못된 주문이 있었는데, 이제 손님이 직접 골라서.', metric: '주문 오류 95% 감소' },
  { name: '최수진 대표', loc: '강남 스시', text: '설치비가 없어서 반신반의했는데, 진짜. QR 스티커도 예쁘게 만들어주시고 세팅도 하루 만에.', metric: '설치비·기기비 0원' },
