...
const FAQ_ITEMS = [
  { q: '정말 설치비가 0원인가요?', a: '네, 설치비·기기비·셋업비 모두 무료입니다. QR 스티커도 무료로 제작하여 배송해드립니다. 별도의 태블릿이나 기기 구매 없이, 기존 스마트폰이나 PC로 관리할 수 있습니다.' },
  ...
  { q: '외국어를 몰라도 사용할 수 있나요?', a: '물론입니다. 한국어로만 메뉴를 등록하시면 됩니다. ZIVO가 14개 언어로 자동 번역합니다. 주문도 한국어로 들어오기 때문에 외국어를 전혀 모르셔도 됩니다.' },
...
export function FAQ() {
  ...
  return (
    <section id="faq" className="py-24 sm:py-32 md:py-40 bg-[#F1F5F9]">
