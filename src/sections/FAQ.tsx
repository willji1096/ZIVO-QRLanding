...
const FAQ_ITEMS = [
  {
    q: '정말 도입 비용이 0원인가요?',
    a: '부담 없이 바로 시작하세요. 도입을 망설이시는 사장님들을 위해 초기 비용을 무료로 지원해드립니다. 별도의 태블릿을 구매하실 필요도 없고, 기존 스마트폰이나 PC로 관리할 수 있습니다.',
  },
  {
    q: '그럼 수수료는 어떻게 되나요?',
    a: '월 고정비 없이 주문당 소정의 수수료만 발생합니다. 구체적인 수수료율은 업장 규모에 따라 다르므로, 도입 상담 시 정확히 안내해드립니다.',
  },
  {
  ...
  {
    q: '언제든 해지할 수 있나요?',
    a: '네, 부담 없이 시작하실 수 있도록 유연한 이용 구조를 지향하고 있습니다. 이용 중단과 관련된 세부 기준은 정책 확정 후 안내드릴 예정입니다.',
  },
  {
    q: '도입까지 얼마나 걸리나요?',
...
export function FAQ() {
  ...
  return (
    <section id="faq" className="py-20 sm:py-24 md:py-28 bg-[#F8FAFC]">
