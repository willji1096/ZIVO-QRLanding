      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-12 gap-5 md:gap-6">
          <motion.div
            ...
            className="md:col-span-7 p-8 md:p-12 rounded-3xl bg-white shadow-[0_0_0_1px_rgba(0,0,0,0.04),0_4px_16px_rgba(0,0,0,0.06)]"
          >
            ...
            <div className="flex items-baseline gap-3">
              <span className="text-[52px] md:text-[64px] font-extrabold text-red-500/80 tracking-[-0.02em] tabular-nums leading-none">72%</span>
          ...
          <div className="md:col-span-5 flex flex-col gap-5 md:gap-6">
            <motion.div
              ...
              className="p-8 md:p-9 rounded-3xl bg-white shadow-[0_0_0_1px_rgba(0,0,0,0.04),0_4px_16px_rgba(0,0,0,0.06)] flex-1"
            >
              ...
              <span className="text-[36px] md:text-[42px] font-extrabold text-amber-500/70 tracking-[-0.02em] tabular-nums leading-none">180만+<span className="text-[16px] font-bold text-amber-400"> /월</span></span>
            </motion.div>
            ...
            >
              ...
              <span className="text-[36px] md:text-[42px] font-extrabold text-violet-500/70 tracking-[-0.02em] tabular-nums leading-none">45%<span className="text-[16px] font-bold text-violet-400"> 가 언어 문제</span></span>
            </motion.div>
          </div>
        </div>
      </div>
